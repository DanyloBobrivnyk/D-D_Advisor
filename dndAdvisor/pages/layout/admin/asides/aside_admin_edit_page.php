<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="../../pages/logged/admin.php" class="brand-link">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
              <a href="../../pages/logged/admin.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="../../pages/layout/admin/content_character_list_admin.php" class="nav-link">
